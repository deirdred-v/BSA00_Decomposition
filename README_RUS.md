...
Резюме:
Знакомство с типовым жизненным циклом разработки программного обеспечения, типовым ролевым составом команды, основными функциями каждой роли на этапах жизненного цикла, правилами декомпозиции и правилами её применения.
...
2. [Chapter II](#chapter-ii) \
    2.1. [Exercise 00 — Creating a workspace (Создание пространства)](#51) \
    2.2. [Exercise 01 — Identifying information sources (Выявление источников информации)](#52) \
    2.3. [Exercise 02 — Creating and maintaining a glossary (Создание и ведение глоссария)](#53) \
    2.4. [Exercise 03 — Concept of Decomposition (Основные понятия декомпозиции)](#53) \
    2.5. [Exercise 04 — Types of Decomposition (Виды декомпозиции)](#55) \
    2.6. [Exercise 05 — Types of Decomposition (Виды декомпозиции)](#56) \
    2.7. [Exercise 06 — Decomposition Rules (Правила декомпозиции)](#57)
